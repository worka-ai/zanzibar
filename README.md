...
and permission checks backed by Keldra 0.16.0. It suits applications whose access
...
```sh
cargo add zanzibar@0.4
cargo add tokio --features macros,rt-multi-thread
```

The adapter targets Keldra 0.16.0. Start Keldra and provision a tenant owner by
...
With Keldra 0.16.0, create and bind new custom realms while one cluster node is
